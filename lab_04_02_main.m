...
title('Адаптивно відфільтрований сигнал при L = 128)'); 
ylabel('Амплітуда');
...
mu2 = 0.01;
[y2, e, b] = lms(x1, s1, mu2, L1);
% Графіки результату фільтрації
figure(10);
subplot(2, 1, 1); plot(t1, x1); grid on;
title('Сигнал з шумом'); ylabel('Амплітуда');
subplot(2, 1, 2); plot(t1, y2); grid on;
title('Адаптивно відфільтрований сигнал (mu = 0.01)'); 
xlabel('Відліки'); ylabel('Амплітуда');

mu3 = 0.001;
[y3, e, b] = lms(x1, s1, mu3, L1);
% Графіки результату фільтрації
figure(11);
subplot(2, 1, 1); plot(t1, x1); grid on;
title('Сигнал з шумом'); ylabel('Амплітуда');
subplot(2, 1, 2); plot(t1, y3); grid on;
title('Адаптивно відфільтрований сигнал (mu = 0.001)'); 
xlabel('Відліки'); ylabel('Амплітуда');

mu4 = 0.00001;
[y4, e, b] = lms(x1, s1, mu4, L1);
% Графіки результату фільтрації
figure(13);
subplot(2, 1, 1); plot(t1, x1); grid on;
title('Сигнал з шумом'); ylabel('Амплітуда');
subplot(2, 1, 2); plot(t1, y4); grid on;
title('Адаптивно відфільтрований сигнал (mu = 0.00001)'); 
xlabel('Відліки'); ylabel('Амплітуда');

mu5 = 0.000001;
[y5, e, b] = lms(x1, s1, mu5, L1);
% Графіки результату фільтрації
figure(14);
subplot(2, 1, 1); plot(t1, x1); grid on;
title('Сигнал з шумом'); ylabel('Амплітуда');
subplot(2, 1, 2); plot(t1, y5); grid on;
title('Адаптивно відфільтрований сигнал (mu = 0.000001)'); 
xlabel('Відліки'); ylabel('Амплітуда');
...
% L2 = 256
L2 = 256;
[y6, e, b2] = lms(x1, s1, mu1, L2);
% Графіки результату фільтрації
figure(15);
subplot(3, 1, 1); plot(t1, x1); grid on;
title('Сигнал з шумом'); ylabel('Амплітуда');
subplot(3, 1, 2); plot(t1, y6); grid on;
title('Адаптивно відфільтрований сигнал (L = 256)'); 
ylabel('Амплітуда');
...
title('АЧХ адаптивного фільтру при L = 256'); 
xlabel('Відліки'); ylabel('Підсилення');
...
N3 = 800; 
 ...
 x3 = s3+v3;
L3 = 512;
[y7, e, b3] = lms(x3, s3, mu1, L3);
% Графіки результату фільтрації
figure(16);
subplot(3, 1, 1); plot(t3, x3); grid on;
title('Сигнал з шумом'); ylabel('Амплітуда');
subplot(3, 1, 2); plot(t3, y7); grid on;
title('Адаптивно відфільтрований сигнал (L = 512)');
ylabel('Амплітуда');
...
title('АЧХ адаптивного фільтру при L = 512'); 
xlabel('Відліки'); ylabel('Підсилення');
...
N4 = 1400; 
 ...
 x4 = s4+v4;
L4 = 1024;
[y8, e, b4] = lms(x4, s4, mu1, L4);
% Графіки результату фільтрації
figure(17);
subplot(3, 1, 1); plot(t4, x4); grid on;
title('Сигнал з шумом'); ylabel('Амплітуда');
subplot(3, 1, 2); plot(t4, y8); grid on;
title('Адаптивно відфільтрований сигнал (L = 1024)'); 
ylabel('Амплітуда');
...
title('АЧХ адаптивного фільтру при L = 1024'); 
xlabel('Відліки'); ylabel('Підсилення');